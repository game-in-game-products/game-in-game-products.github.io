    ...
    return (<div>
        <div className="d-flex flex-column justify-content-center align-items-center vh-100" >
            <div className="text-center w-75">
                ...
                <div className='h-100 ' >
                    <Link to="/join-game"><Button className='m-2  bg-dark' style={{ width: "250px" }}> Join with URL</Button></Link>
                    <Link to="/new-game "><Button className='m-2 ' style={{ width: "250px" }} > Create a new game </Button></Link>
                </div>
            </div>
        </div>
